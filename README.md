...
4. [Các node có sẵn](#4-các-node-có-sẵn)
   ...
   - [SpaceNode](#47-spacenode----khoảng-trống)
   - [EdgeInsets](#48-edgeinsets----paddingmargin)
   - [LayoutDimension](#49-layoutdimension----widthheight-kiểu-xml)
...
### 4.9 `LayoutDimension` — Width/Height kiểu XML
