...
4. [Các node có sẵn](#4-các-node-có-sẵn)
   ...
   - [LayoutDimension](#46-layoutdimension----widthheight-kiểu-xml)
...
ConstraintNode(
    ...
    children = listOf(
        ConstraintChild(
            id             = "avatar",
            node           = ImageNode(
                ImageSource.ResSource(R.drawable.avatar),
...
### 4.6 `LayoutDimension` — Width/Height kiểu XML
...
class WordAdapter(
    ...
    private fun buildWordNode(item: WordItem): LayoutNode = LinearNode(
        ...
        children    = listOf(
            ImageNode(
                ImageSource.ResSource(item.iconRes),
                layoutWidth = LayoutDimension.Fixed(24.dp),
                layoutHeight = LayoutDimension.Fixed(24.dp),
            ),
            LinearNode(
    ...
    return ConstraintNode(
        ...
        children = listOf(
            ...
            ConstraintChild(
                id             = "avatar",
                node           = ImageNode(
                    ImageSource.ResSource(avatarRes),
                    layoutWidth = LayoutDimension.Fixed(48.dp()),
                    layoutHeight = LayoutDimension.Fixed(48.dp()),
                ),
                startToStartOf = PARENT,
...
val icon  = ImageNode(
    ImageSource.ResSource(R.drawable.ic_star),
    layoutWidth = LayoutDimension.Fixed(24.dp),
    layoutHeight = LayoutDimension.Fixed(24.dp)
)
