...
4. [Các node có sẵn](#4-các-node-có-sẵn)
   ...
   - [EdgeInsets](#49-edgeinsets----paddingmargin)
   - [LayoutDimension](#410-layoutdimension----widthheight-kiểu-xml)
...
### 4.10 `LayoutDimension` — Width/Height kiểu XML
